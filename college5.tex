    ...
    \begin{questions}
        ...
        \begin{parts}
        	...
        	\begin{inlinetoprove}
        		...
        		\]
        		\begin{proof}
        			Because $\sum_{k=1}^{\infty} a_k$ is a telescoping series, the following holds for all partial sums of $s := \sum_{k=1}^{\infty} a_k$:
        			\begin{align*}
        				S_n &= \sum_{k=1}^{n} a_k \\
        				&= a_1 + a_2 + ... + a_{n-1} + a_n \\
        				...
        				&= b_n - b_0
        			\end{align*}
        			Now let $n \to \infty$. The limit $\lim_{n \to \infty} b_n - b_0$ exists if and only if $b_n$ converges. Therefore, $\sum_{k=1}^{\infty} a_k$ only converges if $b_n$ converges. Also, we now know:
        			\[
	        			\sum_{k=1}^{\infty} a_k = \lim_{n \to \infty} b_n - b_0
        			\]
        		\end{proof}
