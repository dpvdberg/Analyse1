    ...
    \begin{questions}
	    ...
	    \begin{parts}
	    	...
	    	\begin{proof}
	    		...
	    		Using \ref{th:lim:c/a:infinite}, we can conclude that $p_n, q_n, r_n, s_n \text{ and } t_n$ all converge to 0. Taking all limits except for $p_n$ we find $e_n \xrightarrow{n\to\infty} p_n$, where $p_n \xrightarrow{n\to\infty} 0$, hence
	    		\[
