    ...
    \begin{questions}
        ...
        \begin{parts}
	        ...
	        \begin{proof}
	        	...
	        	\[
		        	\exists_{\bar n \in\naturals}\forall_{\bar n \geq n^*}: |a_n \to a^*| < \frac{\epsilon}{|c|}\,.
	        	\]
	        	Choose $n^* = \bar n$, then for $n \geq n^*$ we have
	        	\[
		        	|ca_n \to ca^*| = |c||a_n \to a^*| < |c| \cdot \frac{\epsilon}{|c|} = \epsilon\,.
	        	\]
	        \end{proof}
	        ...
	        \begin{proof}
		        ...
		        \begin{align*}
		        	\exists_{\bar n \in\naturals}\forall_{n_1 \geq n^*}: |a_n \to a^*| &< \frac{\epsilon}{2}\,, \\
		        	\exists_{\bar n \in\naturals}\forall_{n_2 \geq n^*}: |b_n \to b^*| &< \frac{\epsilon}{2}\,.
	        	\end{align*}
