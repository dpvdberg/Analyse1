    ...
    \begin{questions}
	    ...
	    \begin{parts}
	    	...
	    	\begin{proof}
	    		...
	    		\[
		    		b_n = \frac{1}{p_n} \to \infty \text{ as } n \to \infty
	    		\]
	    	\end{proof}
	    	...
	    	\begin{proof}
	    		...
	    		\[
		    		e_n = \frac{p_n - q_n + r_n}{1 + s_n + t_n} \to 0 \text{ as } n \to \infty
	    		\]
	    	\end{proof}
	    	...
	    	\begin{proof}
	    		...
	    		\[
		    		f_n = \sqrt[n]{n^3} = n^{\frac{3}{n}} = (n^{\frac{1}{n}})^3 = p_n^3 \to 1^3 = 1 \text{ as } n \to \infty 
	    		\]
	    	\end{proof}
	    	...
	    	\begin{proof}
	    		...
	    		\]
	    		because in our case $a = \frac{2}{3} < 1$. Lastly, $s_n$ also converges to $0$, because of the limit \ref{th:lim:1/a:infinite}.
	    		
	    		Now, we can use all of this information to explore the behaviour of $g_n$:
	    		\[
		    		g_n = \frac{3^n - n^3}{2^n + n^2 + 7} = \frac{1 - p_n}{q_n + r_n + s_n} \to \infty \text{ as } n \to \infty		    		
	    		\]
	    	\end{proof}
	    	...
	    	\begin{proof}
	    		...
	    		\[
		    		h_n = \frac{\sqrt{n} - \frac{1}{2n}}{\sqrt[3]{n} + \frac{1}{n^2}} = \frac{1 - p_n}{q_n + r_n} \to \infty \text{ as } n \to \infty
	    		\]	    		
	    	\end{proof}
	    	...
	    	\begin{proof}
	    		...
	    		\[
		    		k_n = \frac{n^8 + n^5}{4n^8 + 5n^6 + 3}= \frac{1 + p_n}{4 + q_n + r_n} \to \frac{1}{4} \text{ as } n \to \infty 
	    		\]
	    	\end{proof}
	    \end{parts}
