...
\begin{document}
    ...
    \begin{questions}
	    ...
	    \begin{parts}
	    	\part
	    	\begin{inlinetoprove}
	    		$c_n \xrightarrow{n\to\infty}0$, i.e. $\forall_{\epsilon > 0}\exists_{n^* \in \naturals}\forall_{n \geq n^*}: \left|\frac{n+3}{n^2-3}\right| < \epsilon\,.$
	    	\end{inlinetoprove}
	    	\begin{proof}
	    		...
	    		&= \frac{n+3}{(n+3)(n-3)} \\
	    		&= \frac{1}{n-3} \\
	    		&< \frac{1}{n^*-3} = \frac{1}{\ceil{1/\epsilon}} < \frac{1}{1/\epsilon} = \epsilon\,.
	    		\end{align*}
	    	\end{proof}
	    	...
	    	\begin{proof}
	    		...
	    		Define $p_n := \frac{n^6}{3^n}$ and let us examine the growth ratio our newly created sequence. This yields
	    		\[
	    		...
	    		\begin{align*}
		    		...
		    		&= \frac{1}{n}|p_n| \\
		    		&< \frac{1}{n}p_5 \\
		    		&< \frac{p_5}{n^*} < \frac{p_5}{p_5/\epsilon}= \epsilon\,.
	    		\end{align*}
	    	\end{proof}
	    	...
	    	\begin{proof}
	    		...
	    		\begin{align*}
		    		...
		    		&= \frac{31}{n+5} \\
		    		&< \frac{31}{n} < \frac{31}{n^*} < \frac{31}{31/\epsilon} = \epsilon\,.
	    		\end{align*}
	    	\end{proof}
	    \end{parts}
     \end{questions}
