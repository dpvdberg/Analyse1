    ...
    \begin{questions}
        ...
        \begin{parts}
        	\part  
	        	...
	        	\end{toprove}
	        	\begin{proof}
	        		$A$ is begrensd en niet leeg, dus $-A$ ook begrensd (per definitie van de verzameling $-A$) en niet leeg. Dus $\sup(-A)$ bestaat.
	        		...
	        		Hieruit volgt dat $-\inf A$ een bovengrens is voor $-A$, ofwel $-\inf A \geq \sup(-A)$. Het rest nog om aan te tonen dat $-\inf A$ de kleinste bovengrens is, ofwel
	        		\[
	        	...
	        	\end{toprove}
	        	\begin{proof}
	        		$A$ en $B$ zijn begrensd en niet leeg, dus $A+B$ ook begrensd (per definitie van de verzameling $A+B$) en niet leeg. Dus $\sup(A+B)$ bestaat.
	        	...
	        	\begin{proof}
	        		...
	        		We moeten enkel nog aantonen dat $\inf A - \sup B$ de grootste ondergrens is voor $A-B$, ofwel
	        		\[
