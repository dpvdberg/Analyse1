...
\begin{document}
    ...
    \begin{questions}
        ...
        \begin{parts}
        	...
        	\[
	        	c_n = \left(1 + \frac{1}{n^2}\right)^n \geq 1^n = 1\,.
        	\]
        	
        	Also, we know
        	\[
	        	c_n = \left(1 + \frac{1}{n^2}\right)^n = \left(1 + \frac{1}{n^2}\right)^{n^2 \cdot \frac{1}{n}} = \left(\left(1 + \frac{1}{n^2}\right)^{n^2}\right)^\frac{1}{n} = \sqrt[n]{\left(1 + \frac{1}{n^2}\right)^{n^2}}\,,
        	\]
        	which, using the fact that
        	\[
	        	\forall_{n\in\naturals}: \left(1 + \frac{1}{n^2}\right)^{n^2} \leq 3\,,
        	\]
        	we have
        	\[
	        	c_n = \sqrt[n]{\left(1 + \frac{1}{n^2}\right)^{n^2}} \leq \sqrt[n]{3} \xrightarrow{n\to\infty} 1\,.
        	\]
        	
        	Using the Squeeze theorem we find $c_n \xrightarrow{n\to\infty} 1$.
        ...
        \begin{proof}
        	...
        	\[
	        	\exists_{\bar n \in \naturals}\forall_{n \geq \bar n}: |a_n - a^*| < \epsilon\,.
        	\]
        ...
        \begin{parts}
        	...
        	Define
        	\[
	        	a_n =  n  - \frac{\ceil{p_n}\left(\ceil{p_n}-1\right)}{2} = \{0,1,\enskip0,1,2,\enskip0,1,2,3,\ldots\}\,,
	        \]
	        where
	        \[
        	...
        	Let
        	\[
	        	a_n = \frac{1}{2}\left(1 + \sin n\right)\,.
        	\]
        	
        	Now define $Q$ to be the set
        	\[
	        	Q = \left\{ q \in \reals \mid q = n/2\pi \pmod{2\pi}\,, n\in\naturals \right\}\,.
        	\]
        	
        	We find that $Q$ is uniformly distributed dense under the interval $[0,2\pi]$. Hence, every point in the interval $[-1,1]$ is a limit point of the sequence $\{\sin n\}$ and therefore $\{a_n\}$ has the same properties for the interval $[0,1]$. We conclude $V(\{a_n\}) = [0,1]$.
        \end{parts}
     \end{questions}
\end{document}