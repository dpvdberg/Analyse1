...
\begin{document}
    ...
    \begin{questions}
        ...
        \begin{parts}
        	...
        	We find that $Q$ is uniformly distributed dense under the interval $[0,2\pi]$. Hence, every point in the interval $[-1,1]$ is a limit point of the sequence $\{\sin n\}$ and therefore $\{a_k\}$ has the same properties for the interval $[0,1]$. We conclude $V(\{a_n\}) = [0,1]$.
        \end{parts}
     \end{questions}
\end{document}